import {
  LocalLoadableType,
  LocalLoadableInterface,
  LocalLoadableAbstractClass,
  LocalNotLoadableInterface,
  LocalNotLoadableAbstractClass,
  LocalNotLoadableType,
  LocalLoadableTypeWithArgs,
  LocalLoadableInterfaceWithArgs,
  LocalLoadableAbstractClassWithArgs,
} from './LocalLoadableType';
...
export class ImplementsLocalLoadableInterfaceWithArgs
  implements LocalLoadableInterfaceWithArgs<LocalLoadableInterface>
{
  a = 1;
}
