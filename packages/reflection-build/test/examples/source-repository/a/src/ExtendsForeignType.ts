import {
  LoadableForeignType,
  NotLoadableForeignType,
  LoadableForeignInterface,
  NotLoadableForeignInterface,
  LoadableForeignAbstractClass,
  NotLoadableForeignAbstractClass,
} from '@proteinjs/reflection-build-test-b';
