import { InterfaceDeclaration as ParserInterfaceDeclaration } from '../../../modules/typescript-parser';
...
export async function createInterfaceDeclaration(
  parserInterfaceDeclaration: ParserInterfaceDeclaration,
  ...
  return new InterfaceDeclaration(
    ...
    parserInterfaceDeclaration.name,
    properties,
    methods,
    parameters,
    directParents,
