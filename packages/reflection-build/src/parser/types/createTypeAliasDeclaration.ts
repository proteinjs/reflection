...
export async function createTypeAliasDeclaration(
  parserTypeAliasDeclaration: ParserTypeAliasDeclaration,
  ...
  const directParentTypeAliases = await typeAliasDeclarationsFromParserTypeAliases(
    parserTypeAliasDeclaration.type.parentTypes,
    packageNameFinder
  );
  return new TypeAliasDeclaration(
    packageNameFinder.referencingPackage,
    parserTypeAliasDeclaration.name,
    parameters,
    directParentTypeAliases,
    filePath
  );
}

export async function typeAliasDeclarationsFromParserTypeAliases(
  parserTypeAliasDeclarations: ParserTypeAlias[],
  packageNameFinder: PackageNameFinder
): Promise<TypeAliasDeclaration[]> {
...
export async function typeAliasDeclarationFromParserTypeAlias(
  parserTypeAlias: ParserTypeAlias,
  packageNameFinder: PackageNameFinder
): Promise<TypeAliasDeclaration> {
...
export async function typeAliasDeclarationsFromNames(
  typeNames: string[],
  packageNameFinder: PackageNameFinder
): Promise<TypeAliasDeclaration[]> {
...
export async function typeAliasDeclarationFromName(
  typeName: string,
  packageNameFinder: PackageNameFinder
): Promise<TypeAliasDeclaration> {
