...
class TypescriptParser {
  ...
  parseSource(source, scriptKind = typescript_1.ScriptKind.TS) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      return yield this.parseTypescript(
        typescript_1.createSourceFile('inline.tsx', source, typescript_1.ScriptTarget.ES2015, true, scriptKind),
        '/'
      );
    });
  }
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
      return filePathes
        .map((o) => {
          ...
          return typescript_1.createSourceFile(
            o,
            fs_1.readFileSync(o).toString(),
