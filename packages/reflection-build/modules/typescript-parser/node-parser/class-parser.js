  ...
  node.parameters.forEach((o) => {
    if (TypescriptGuards_1.isIdentifier(o.name)) {
      ctor.parameters.push(
        new ParameterDeclaration_1.ParameterDeclaration(
          o.name.text,
          parse_utilities_1.getNodeType(o.type),
          o.getStart(),
          o.getEnd()
        )
      );
      ...
      parent.properties.push(
        new PropertyDeclaration_1.PropertyDeclaration(
          o.name.text,
          parse_utilities_1.getNodeVisibility(o),
          parse_utilities_1.getNodeType(o.type),
          !!o.questionToken,
          parse_utilities_1.containsModifier(o, typescript_1.SyntaxKind.StaticKeyword),
          o.getStart(),
          o.getEnd()
        )
      );
        ...
        elements
          .map((bind) => {
            if (TypescriptGuards_1.isIdentifier(bind.name)) {
              return new ParameterDeclaration_1.ParameterDeclaration(
                bind.name.text,
                undefined,
                bind.getStart(),
                bind.getEnd()
...
function parseClass(tsResource, node) {
  ...
  const classDeclaration = new ClassDeclaration_1.ClassDeclaration(
    name,
    ...
    node.members.forEach((o) => {
      ...
      if (TypescriptGuards_1.isGetAccessorDeclaration(o)) {
        classDeclaration.accessors.push(
          new AccessorDeclaration_1.GetterDeclaration(
            o.name.text,
            parse_utilities_1.getNodeVisibility(o),
            parse_utilities_1.getNodeType(o.type),
            o.modifiers !== undefined && o.modifiers.some((m) => m.kind === typescript_1.SyntaxKind.AbstractKeyword),
            parse_utilities_1.containsModifier(o, typescript_1.SyntaxKind.StaticKeyword),
            o.getStart(),
            o.getEnd()
          )
      ...
      if (TypescriptGuards_1.isSetAccessorDeclaration(o)) {
        classDeclaration.accessors.push(
          new AccessorDeclaration_1.SetterDeclaration(
            o.name.text,
            parse_utilities_1.getNodeVisibility(o),
            parse_utilities_1.getNodeType(o.type),
            o.modifiers !== undefined && o.modifiers.some((m) => m.kind === typescript_1.SyntaxKind.AbstractKeyword),
      ...
      if (TypescriptGuards_1.isConstructorDeclaration(o)) {
        const ctor = new ConstructorDeclaration_1.ConstructorDeclaration(
        ...
        const method = new MethodDeclaration_1.MethodDeclaration(
          ...
          !!o.questionToken,
          parse_utilities_1.containsModifier(o, typescript_1.SyntaxKind.StaticKeyword),
          parse_utilities_1.containsModifier(o, typescript_1.SyntaxKind.AsyncKeyword),
          o.getStart(),
          o.getEnd()
        );
  ...
  if (node.heritageClauses) {
    for (const heritageClause of node.heritageClauses) {
      if (heritageClause.token == typescript_1.SyntaxKind.ExtendsKeyword) {
        ...
        for (let heritageType of heritageClause.getChildren()) {
          const expressionText = heritageType.getText().trim();
          if (expressionText == 'implements') continue;
