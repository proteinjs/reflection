  ...
  get exported() {
    return [
      ...this.resource.declarations.filter(
        (o) =>
          TypescriptHeroGuards_1.isExportableDeclaration(o) && o.isExported && o.name === this.declarationIdentifier
      ),
      ...this.resource.resources.filter(
        (o) =>
          (o instanceof Namespace_1.Namespace || o instanceof Module_1.Module) && o.name === this.declarationIdentifier
      ),
    ];
  }
}
